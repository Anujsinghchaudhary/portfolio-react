      ...
      <div className="footer-top">
        ...
        <div className="footer-top-right">
          <div className="footer-email-input">
            ...
            <div>
              <div className="footer-subscribe"><StyledWrapper><Button /></StyledWrapper></div>            </div>
          </div>
          <hr />
          <div className="footer-bottom">
            <p className="footer-bottom-left">Check out my social profiles</p>
            <div className="footer-bottom-right">
              <div className="social-buttons">
                <a href={socail_links.github} target='_blank' className="social-button github">
                ...
                <a href={socail_links.linkedin} target='_blank' className="social-button linkedin">
                ...
                <a href={socail_links.instagram} target='_blank' className="social-button instagram">
